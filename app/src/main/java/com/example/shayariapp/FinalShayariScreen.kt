...
fun PreviewFinalScreen() {
    FinalShayariScreen(null, "Tere pyaar mein kho gaye hum","Love")
}

@Composable
fun FinalShayariScreen(navHostController: NavHostController?=null, finalShayari: String, title: String) {
    Surface {
        ...
        Box(
            ...
            Column{
                MainToolBar(title) { navHostController?.popBackStack() }
